let endOfTime = new Date('2070-01-01T00:00:00.000Z')
...
function findMinChildIndex(minHeap, leftIndex, rightIndex) {
    ...
    if (leftChild !== undefined) {
        if (rightChild === undefined) {
            ...
            minChildIndex = rightChild.value.t < leftChild.value.t ? rightIndex : leftIndex;
        }
    }
...
function bubbleDown(minHeap, index) {
    ...
    while (minChild !== undefined && current.value.t > minChild.value.t) {
